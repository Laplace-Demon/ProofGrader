...
((PBinPred PROP.RLe (TBinOp TERM.RMult
	...
	((TVar "y" ))	((TVar "y" )))))))	((TNum 2)))))(PrPoseWithoutProof 6  6 
	PROOF.FSGAverage
((PBinPred PROP.RLe (TBinOp TERM.RMult
	...
	((TBinOp TERM.RMult
	((TVar "y" ))	((TVar "y" ))))	((TBinOp TERM.RMult
	((TVar "z" ))	((TVar "z" )))))))	((TNum 2)))))(PrPoseWithoutProof 8  8 
	PROOF.FSGAverage
((PBinPred PROP.RLe (TBinOp TERM.RMult
	...
	((TVar "x" ))	((TVar "x" )))))))	((TNum 2)))))((PrConclWithoutProof 10 10 (PROOF.FAddEqn ["___hyp0" ; "___hyp1" ; "___hyp2" ])))))).
