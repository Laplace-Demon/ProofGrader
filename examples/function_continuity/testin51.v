...
((TBinOp TERM.RDiv ((TBinOp TERM.RMult
	((TNum 3))	((TVar "n" ))))	((TBinOp TERM.RPlus
	((TBinOp TERM.RMult ((TNum 5))	((TVar "n" ))))	((TNum 2))))))))
(TBinOp TERM.RDiv ((TNum 3))	((TNum 5)))).
...
((TBinOp TERM.RDiv
	...
	((TBinOp TERM.RMult ((TNum 25))	((TVar "n" ))))	((TNum 10))))))
	(PBinPred PROP.RLe (TBinOp TERM.RDiv
	((TNum 6))	((TBinOp TERM.RMult((TNum 25))	((TVar "n" )))))(TVar "a" ))))))
	(PrConclWithoutProof 17 17 PROOF.FNoHint))))))))))))).
