...
((PrAction 11 11 (PROOF.ASuppose ((PBinPred PROP.RGt (TVar "n" )(TVar "N" ))))
 ((PrPoseWithoutProof 12 16 PROOF.FNoHint
	)((PLongOrder 	PROP.REq 
...
((TBinOp TERM.RDiv
	...
	((TNum 25))	((TVar "n" )))))(TVar "a" ))))))(PrConclWithoutProof 17 17 PROOF.FNoHint))))))))))))).
...
Definition goal := check_rec'_show_pg pg' pr' 4.

Compute goal.

Compute  check_fwd_proof pg' PROOF.FSeqLimitDef stmt.


Compute TERM_PM.pattern_match_prop_rec pg'.(concl) (fst LimitDef_statement) nil nil.
